...
- Use cross-platform detection for SSH-agent, now supports Pageant on Windows [#21](https://github.com/leopoggiani/terraform-backend-git/pull/21) (Authored-by: [@blaubaer](https://github.com/blaubaer))
